...
public class TaskResourceIntTest {
    ...
    private static final Integer DEFAULT_ESTIMATE = 1;
    private static final Integer UPDATED_ESTIMATE = 2;
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getStatusDate()).isEqualTo(DEFAULT_STATUS_DATE);
        assertThat(testTask.getEstimate()).isEqualTo(DEFAULT_ESTIMATE);
    }
    ...
    @Test
    @Transactional
    public void checkEstimateIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getStatusDate()).isEqualTo(UPDATED_STATUS_DATE);
        assertThat(testTask.getEstimate()).isEqualTo(UPDATED_ESTIMATE);
    }
